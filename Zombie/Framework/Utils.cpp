...
{
	return sf::Vector2f(Clamp(v.x , rect.left , 
		rect.left + rect.width) , Clamp(v.y , rect.top , 
			rect.top + rect.height));
}

sf::FloatRect Utils::ResizeRect(const sf::FloatRect& rect, 
...
sf::Vector2f Utils::GetNomalize(const sf::Vector2f& vec)
{
